...
/**
 * Report: تلاميذ راسبون من الدور الثاني — Precise Layout synchronized with successful report
 * style (A3 Landscape).
 */
public class gradReportFailSecondRound extends JFrame {
    ...
    public gradReportFailSecondRound(String profession, String center, String region, String system, List<Student> students) {
        this(profession, center, region, system, students, null, null);
    }

    public gradReportFailSecondRound(String center, String region, List<Student> students, String selectedMonth, String admissionMonth) {
    ...
    public gradReportFailSecondRound(String profession, String center, String region, String system, List<Student> students,
        ...
        setTitle("كشف الراسبين من الدور الثاني - " + profession);
    ...
    private JPanel buildHeader(int pageNum, int totalPages) {
        ...
        JLabel sub = label("تلاميذ راسبون من الدور الثاني", 200, true);
    ...
    private JPanel buildTable(List<Student> chunk) {
        ...
        for (int i_chunk = 0; i_chunk < 15; i_chunk++) {
            if (i_chunk < chunk.size()) {
                ...
                row[c++] = "راسب من الدور الثاني"; // حالة
