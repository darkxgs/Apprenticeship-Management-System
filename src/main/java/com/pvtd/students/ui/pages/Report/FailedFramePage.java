    ...
    public FailedFramePage() {
        ...
        jTable1.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            @Override public Component getTableCellRendererComponent(JTable t, Object v, boolean sel, boolean foc, int row, int col) {
                ...
                if (!sel) c.setBackground(row % 2 == 0 ? Color.WHITE : new Color(255, 245, 245));
        ...
        javax.swing.JLabel titleLbl = new javax.swing.JLabel("  تقرير الراسبين", javax.swing.SwingConstants.RIGHT);
...
i++
 ...
 //---------------------------------------------------------------
    ...
    private void initComponents() {
        ...
        buttonGradient3.setText("رفع تقرير بي الطلاب الراسبين بدون الدرجات");
