    ...
    public ScoundRoundFramePage() {
        ...
        jTable1.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            @Override public Component getTableCellRendererComponent(JTable t, Object v, boolean sel, boolean foc, int row, int col) {
                ...
                if (!sel) c.setBackground(row % 2 == 0 ? Color.WHITE : new Color(255, 250, 235));
        ...
        javax.swing.JLabel titleLbl = new javax.swing.JLabel("  تقرير دور ثاني", javax.swing.SwingConstants.RIGHT);
        ...
        buttonGradient3.setText("📄  إنشاء تقرير PDF لدور ثاني");
...
i++
 ...
 //---------------------------------------------------------------
    ...
    private void initComponents() {
        ...
        gridBagConstraints.insets = new java.awt.Insets(29, 98, 29, 286);
        ...
        buttonGradient3.setText("رفع تقرير بي الطلاب الدور ثاني بدون الدرجات");
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(44, 397, 27, 0);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(51, 261, 0, 32);
    ...
    private void buttonGradient3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonGradient3ActionPerformed
       ...
       SecondRound reound =new SecondRound();

        DefaultTableModel model1 = (DefaultTableModel) jTable1.getModel();
        DefaultTableModel model2 = (DefaultTableModel) reound.jTable2.getModel();
...
String centerName = cmdcenter.getSelectedItem().toString();
        reound.loadCenterData(centerName);
        reound.cent.setText(centerName);
        reound.createPDF();
        }
        {
