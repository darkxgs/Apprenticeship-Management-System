...
/**
 * Report: تلاميذ مسحوب ملفاتهم — Precise Layout synchronized with gradReportFail
 * style (A3 Landscape).
 */
public class gradReportWithdrawal extends JFrame {
    ...
    public gradReportWithdrawal(String profession, String center, String region, String system, List<Student> students) {
        this(profession, center, region, system, students, null, null);
    }

    public gradReportWithdrawal(String center, String region, List<Student> students, String selectedMonth, String admissionMonth) {
    ...
    public gradReportWithdrawal(String profession, String center, String region, String system, List<Student> students,
        ...
        setTitle("كشف مسحوبي الملفات - " + profession);
    ...
    private JPanel buildHeader(int pageNum, int totalPages) {
        ...
        JLabel sub = label("تلاميذ مسحوب ملفاتهم", 200, true);
    ...
    private JPanel buildTable(List<Student> chunk) {
        ...
        for (int i_chunk = 0; i_chunk < 15; i_chunk++) {
            if (i_chunk < chunk.size()) {
                ...
                row[c] = (status != null && !status.isEmpty()) ? status : "سحب الملف";
                model.addRow(row);
            } else {
                Object[] row = new Object[cols.length];
    ...
    private JPanel buildPagePanel(List<Student> chunk, int pageNum, int totalPages) {
        ...
        int headerH = 1100, footerH = 800, tableHeaderH = 600;
