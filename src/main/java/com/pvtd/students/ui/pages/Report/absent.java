...
public class absent extends javax.swing.JFrame {
    ...
    public void buildPagePanel(int rowCount) {
        ...
        jLabel2.setBounds(rAlignX, 35, rWidth, 30);
        jLabel3.setBounds(rAlignX, 60, rWidth, 30);
        jLabel4.setBounds(rAlignX, 85, rWidth, 30);
        ...
        jScrollPane2.setBounds(40, tableY, tableWidth, 1610);
        
        // ضبط عرض الأعمدة للـ A3
        ...
        // Footer
        int footerY = 1900;
        jSeparator1.setBounds(40, footerY - 10, tableWidth, 5);
