        ...
        ReportWorker worker = new ReportWorker(this, "كشف المفصولين بالدرجات", null) {
            ...
            protected Void doInBackground() throws Exception {
                ...
                try (Connection con = DatabaseConnection.getConnection()) {
                        ...
                        try (PreparedStatement ps = con.prepareStatement(sql)) {
                            ...
                            try (ResultSet rs = ps.executeQuery()) {
                                while (rs.next()) {
                                    ...
                                    st.setExamSystem(rs.getString("exam_system")); st.setCoordinationNo(rs.getString("coordination_no"));
                    ...
                    generatePdfFiles(studentsByRegion, centerName, selMonth, admMonth, "التقارير/تبييضة/مفصولين");
                }
            ...
            private void generatePdfFiles(java.util.LinkedHashMap<String, java.util.List<com.pvtd.students.models.Student>> data, 
                ...
                String combinedFn = folderPath + "/مجمع تبييض مفصولين.pdf";
                ...
                for (java.util.Map.Entry<String, java.util.List<com.pvtd.students.models.Student>> entry : data.entrySet()) {
                    ...
                    gradReportSequential report = new gradReportSequential("تلاميذ مفصولين", new java.awt.Color(128, 0, 128), center, region, entry.getValue(), selM, admM);
