        ...
        ReportWorker worker = new ReportWorker(this, "كشف المحرومين بالدرجات", null) {
            ...
            protected Void doInBackground() throws Exception {
                ...
                try (Connection con = DatabaseConnection.getConnection()) {
                    ...
                    generatePdfFiles(studentsByRegion, centerName, selMonth, admMonth, "التقارير/تبييضة/محرومين");
                }
            ...
            private void generatePdfFiles(java.util.LinkedHashMap<String, java.util.List<com.pvtd.students.models.Student>> data, 
                ...
                String combinedFn = folderPath + "/مجمع تبييض محرومين.pdf";
                ...
                for (java.util.Map.Entry<String, java.util.List<com.pvtd.students.models.Student>> entry : data.entrySet()) {
                    ...
                    gradReportSequential report = new gradReportSequential("تلاميذ محرومون", new java.awt.Color(200, 0, 0), center, region, entry.getValue(), selM, admM);
