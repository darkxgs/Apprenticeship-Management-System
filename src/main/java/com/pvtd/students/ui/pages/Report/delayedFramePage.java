 ...
 //---------------------------------------------------------------
    ...
    private void buttonSecretReportActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        for (int row : selectedRows) {
            ...
            String seatNo = String.valueOf(model1.getValueAt(row, 4)); 
            String prof   = String.valueOf(model1.getValueAt(row, 2)); 
        ...
        ReportWorker worker = new ReportWorker(this, "كشف المؤجلين بالدرجات", null) {
            ...
            protected Void doInBackground() throws Exception {
                ...
                String fn = "Detailed_Delayed_Report_All.pdf";
                ...
                try (Connection con = DatabaseConnection.getConnection()) {
                    ...
                    for (java.util.Map.Entry<String, java.util.List<String>> entry : byProfession.entrySet()) {
                        ...
                        gradReportGeneric report = new gradReportGeneric(prof, centerName, regionName, systemName, list, "تلاميذ مؤجلون", new java.awt.Color(200, 150, 0), "Detailed_Delayed_Report");
