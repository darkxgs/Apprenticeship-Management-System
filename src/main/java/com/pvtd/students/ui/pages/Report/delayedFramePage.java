        ...
        ReportWorker worker = new ReportWorker(this, "كشف المؤجلين بالدرجات", null) {
            ...
            protected Void doInBackground() throws Exception {
                ...
                try (Connection con = DatabaseConnection.getConnection()) {
                    ...
                    java.io.File folder = new java.io.File("التقارير/تبييضة/مؤجلين");
                    ...
                    for (java.util.Map.Entry<String, java.util.LinkedHashMap<String, java.util.List<String>>> regionEntry : byRegion.entrySet()) {
                        ...
                        String fn = "التقارير/تبييضة/مؤجلين/" + sanitizedRegion + ".pdf";
            ...
            protected Void doInBackground() throws Exception {
                ...
                try (java.sql.Connection con = com.pvtd.students.db.DatabaseConnection.getConnection()) {
                    ...
                    for (int i = 0; i < selectedRows.length; i++) {
                        ...
                        // Note: in delayedFramePage, profession is index 2
