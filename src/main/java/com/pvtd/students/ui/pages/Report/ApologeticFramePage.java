...
public void loadStudents(String center) {
 ...
 //---------------------------------------------------------------
    ...
    private void initComponents() {
        ...
        buttonGradient3.setText("رفع تقرير بي الطلاب المعتذرين بدون الدرجات");
    ...
    private void buttonGradient3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonGradient3ActionPerformed
        ...
        String getcenter = cmdcenter.getSelectedItem().toString();
        report.loadCenterData(getcenter);
        report.cent.setText(getcenter);
        report.createPDF();
        }
        {
