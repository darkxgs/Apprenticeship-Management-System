...
public class ApologeticFramePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("كشف الطلاب المعتذرين");
        combobox2.setLabeText("المنطقة");
        combobox2.addActionListener(this::combobox2ActionPerformed);

        buttonGradient2.setText("كشف الطلاب بدون درجات");
        buttonGradient2.setColor1(new java.awt.Color(9, 54, 55));
        buttonGradient2.setRadius(30);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(27, 27, 27)
                .addComponent(combobox2, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(39, 39, 39)
                .addComponent(cmdcenter, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        ReportWorker worker = new ReportWorker(this, "كشف المعتذرين بالدرجات", null) {
            ...
            protected Void doInBackground() throws Exception {
                ...
                try (Connection con = DatabaseConnection.getConnection()) {
                        ...
                        try (PreparedStatement ps = con.prepareStatement(sql)) {
                            ...
                            try (ResultSet rs = ps.executeQuery()) {
                                while (rs.next()) {
                                    ...
                                    if (r == null || r.trim().isEmpty()) r = combobox2.getSelectedItem().toString();
                    ...
                    generatePdfFiles(studentsByRegion, centerName, selMonth, admMonth, "التقارير/تبييضة/معتذرين");
                }
            ...
            private void generatePdfFiles(java.util.LinkedHashMap<String, java.util.List<com.pvtd.students.models.Student>> data, 
                ...
                String combinedFn = folderPath + "/مجمع تبييض معتذرين.pdf";
                ...
                for (java.util.Map.Entry<String, java.util.List<com.pvtd.students.models.Student>> entry : data.entrySet()) {
                    ...
                    com.itextpdf.text.pdf.PdfWriter.getInstance(doc, new FileOutputStream(fn));
                    doc.open();

                    gradReportSequential report = new gradReportSequential("تلاميذ معتذرون", new java.awt.Color(0, 153, 76), center, region, entry.getValue(), selM, admM);
