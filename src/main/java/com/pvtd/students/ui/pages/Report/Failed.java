...
public class Failed extends javax.swing.JFrame {
    ...
    public Failed() {
        ...
        if (jTable2.getColumnCount() >= 6) {
            jTable2.getColumnModel().getColumn(0).setHeaderValue("<html><RIGHT>حالة<br>التلميذ</RIGHT></html>");
            jTable2.getColumnModel().getColumn(1).setHeaderValue("<html><RIGHT>رقم<br>الجلوس</RIGHT></html>");
            jTable2.getColumnModel().getColumn(2).setHeaderValue("<html><RIGHT>رقم<br>التسجيل</RIGHT></html>");
        ...
        header.setDefaultRenderer(new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value,
                ...
                setHorizontalAlignment(javax.swing.SwingConstants.RIGHT); // توسيط الكلام في الهيدر
    ...
    public void buildPagePanel(int rowCount) {
        ...
        jLabel6.setBounds(450, 120, 300, 70); // تلاميذ راسبون
                ...
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addContainerGap()
                                                .addComponent(jLabel13, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
