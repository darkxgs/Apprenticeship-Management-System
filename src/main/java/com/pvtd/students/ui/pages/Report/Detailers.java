...
public class Detailers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 1167,
                                javax.swing.GroupLayout.PREFERRED_SIZE));
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 1387,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void buildPagePanel(int rowCount) {
        ...
        jLabel5.setBounds((pageWidth - 600)/2, 40, 600, 35); // نتائج امتحان...
        jLabel6.setBounds((pageWidth - 400)/2, 80, 400, 50); // تلاميذ مفصولون
    ...
    public void loadCenterData(String centerName) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                regoin.setText(regio != null ? regio : "—"); // المنطقة
                system.setText(syste != null ? syste : ""); // النظام
            } else {
                regoin.setText("—");
                system.setText("");
            }
    ...
    public void createPDFGroupedBySystem(
            java.util.Map<String, java.util.List<java.util.Vector>> bySystem,
