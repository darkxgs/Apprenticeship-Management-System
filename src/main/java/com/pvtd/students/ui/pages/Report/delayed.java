    ...
    try (Connection con = DatabaseConnection.getConnection()) {
        ...
        while (rs.next()) {
            ...
            model.addRow(new Object[]{
                "مؤجل",           // 0: حالة التلميذ (تظهر في اليسار)
...
/**
 * Builds a standardized A3 Landscape panel (2800x1980) with dynamic row scaling.
 */
public void buildPagePanel(int rowCount) {
    ...
    jLabel14.setBounds(1050, labelsY, 200, 40); // كتبه (right)
    jLabel18.setBounds(750, labelsY, 200, 40); // املاه
    jLabel17.setBounds(450, labelsY, 200, 40); // راجعه
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(jLabel3, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                .addGap(70, 70, 70)
