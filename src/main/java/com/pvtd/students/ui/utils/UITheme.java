...
public class UITheme {
    ...
    public static final Color BG_LIGHT = Color.decode("#F1F5F9"); // Slightly darker (Slate 100)
    public static final Color BG_SIDEBAR = Color.decode("#0F172A"); // Slate 900
    public static final Color CARD_BG = Color.WHITE;
    public static final Color TABLE_GRID = Color.decode("#E2E8F0"); // Clear grid lines
